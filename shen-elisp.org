...
Some might wonder why we're using ~(string= ...)~ to compare lists and hash tables.
The unsatisfying answer is that it was about 30% faster than whatever I could cook
up in Elisp.
